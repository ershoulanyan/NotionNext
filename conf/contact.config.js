...
module.exports = {
  ...
  CONTACT_EMAIL:
    ...
    '2200857491@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'http://weibo.cn/qr/userinfo?featurecode=profile_qrcode&uid=6983565421', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKTREE: process.env.NEXT_PUBLIC_CONTACT_LINKTREE || 'https://ershoulanyan.github.io/LinkTree', // 你的linktree 首页
  CONTACT_QQ: process.env.NEXT_PUBLIC_CONTACT_QQ || 'https://qm.qq.com/q/WTsMADoqkc', // 你的QQ 
