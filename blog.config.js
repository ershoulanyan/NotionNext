...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '多维SCANNER', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🥞没钱且不是艺术家🥞', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://next.bluess.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 多维', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '没钱且不是艺术家, 艺术就是无神论者的有神论,渴望自由和金钱,生活大爆炸',
