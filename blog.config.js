...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '艺术就是大爆炸, 没钱且不是艺术家,达西咖啡馆',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '二手蓝烟', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不要去营造，但要去感受', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.bluess.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, bluess.store', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2200857491@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CAN_COPY: process.env.NEXT_PUBLIC_CAN_COPY || false, // 是否允许复制页面内容 默认允许true、如果设置为false、则全栈禁止复制内容。
  // 自定义右键菜单
